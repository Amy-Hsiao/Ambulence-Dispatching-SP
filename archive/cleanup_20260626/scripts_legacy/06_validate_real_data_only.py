"""Validate real-data CSV files without solving an optimization model."""
...
from src.ambulance_sp.data_loading.real_data_loader import build_real_instance_skeleton
...
def main() -> None:
    ...
    if payload["validation"]["errors"]:
        raise SystemExit(payload["validation"]["errors"])
